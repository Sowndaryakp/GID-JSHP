...
const fetchData = async () => {
  try {
    const response = await fetch("http://172.18.100.240:6969/elements");
...
const saveEditedElement = async (index) => {
  ...
  try {
    const url = `http://172.18.100.240:6969/elements/${editedElement.type}`;
...
const deleteElement = async (element) => {
  try {
    const url = `http://172.18.100.240:6969/elements/${element.type}`;
