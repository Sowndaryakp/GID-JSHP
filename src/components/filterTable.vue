...
const fetchDataForParameters = async () => {
  try {
    const endpoints = {
      ...
      range: 'http://172.18.100.240:6969/elements',
      machine_id: 'http://172.18.100.240:6969/machines',
      welder_name: 'http://172.18.100.240:6969/welder/',
      project: 'http://172.18.100.240:6969/op_shift/',
      I_no: 'http://172.18.100.240:6969/op_shift/',
      Fc_no: 'http://172.18.100.240:6969/op_shift/',
      ...
      plate_thickness: 'http://172.18.100.240:6969/plate/plate',
      plate_description: 'http://172.18.100.240:6969/plate/plate',
    };
