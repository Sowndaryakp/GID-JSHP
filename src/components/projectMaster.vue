...
const submitProjectForm = async () => {
  try {
    ...
    const response = await axios.post('http://172.18.100.240:6969/project/', formData);
...
const fetchData = async () => {
  try {
    const response = await fetch("http://172.18.100.240:6969/project/");
...
const saveEditedProject = async (index) => {
  ...
  try {
    const url = `http://172.18.100.240:6969/project/${editedProject.project}`;
...
const deleteProject = async (project, I_no, Fc_no) => {
  try {
    const url = `http://172.18.100.240:6969/project/${project.project}?project=${project.project}&I_no=${project.I_no}&Fc_no=${project.Fc_no}`;
